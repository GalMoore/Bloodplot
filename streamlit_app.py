...
if 'df' in locals() and not df.empty:
    ...
    if 'Text' in df.columns:
        ...
        st.markdown('<small><p style="color:gray;">We are processing your data... Allow up to 10 seconds per page (i.e you will wait 40 seconds for 4 pages to run</p></small>', unsafe_allow_html=True)
